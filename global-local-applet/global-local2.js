...
document.getElementById("y-at-t1").innerHTML = (yAtT1).toFixed(0);
...
// Classical path button
document.getElementById("reset-button").onclick = function() {
    document.getElementById(`y${1}-slider`).value = yAtT1;
    updateSliderInfo(1);
    plotIntegral();
    plotIntegralPoint();
}
